...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Super_Copier_dialog_base.ui'))
    
FORM_CLASS2, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Super_Copier_dialog_fields.ui'))


class Super_CopierDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(Super_CopierDialog, self).__init__(parent)
...
class Super_CopierDialog2(QtGui.QDialog, FORM_CLASS2):
    def __init__(self, parent=None):
        """Constructor."""
